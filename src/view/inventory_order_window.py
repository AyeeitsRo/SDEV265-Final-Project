...
class InventoryOrderWindow(QWidget):
    def __init__(self, controller):
        ...
        # Move "+ Add" button below the table
        ...
        # Submit button stays where it originally was
    ...
    def add_entry(self):
        ...
        # Add the red "-" button only if it's not the first entry
        if self.entry_count > 1:
            ...
            # When the button is clicked, it will remove the entry
    ...
    def remove_entry(self, entry_frame):
        # Remove the entry frame from the scroll layout
